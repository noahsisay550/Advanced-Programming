...
public class LoginForAdmin extends Application {
...
class LoginForPrisoner extends Application{
    ...
    private TextField UNameTxf;
    private Text wrongText;
    private Button btnForgotPass, btnLogin, btnCreateA, btnGoBack;
    ...
    public void start(Stage primaryStage){
        ...
        btnCreateA = new Button("Create Account");
        btnCreateA.setPrefSize(120,15);
        btnCreateA.setLayoutX(360);
        btnCreateA.setLayoutY(230);
        btnCreateA.setFont(Font.font("Courier",FontWeight.BOLD,FontPosture.REGULAR,12));
        btnLogin = new Button("Login");
        btnLogin.setPrefSize(100,15);
        btnLogin.setLayoutX(495);
        btnLogin.setLayoutY(230);
        ...
        Pane.getChildren().addAll(WelcomeIV, wrongText, lblUserName, lblPassword, UNameTxf, passField, btnLogin, btnCreateA, btnForgotPass, btnGoBack);
